...
class NavBar(CTkFrame):
    def __init__(self, master: CTkFrame):
        ...
        self.homeButton = CTkButton(
            ...
            command=lambda: [self.select(self.homeButton), home.HomePage(master.window)],
            corner_radius=10,
            width=70,
            height=70,
            text="",
        ...
        self.patientsButton = CTkButton(
            ...
            fg_color=Colors.Cadet,
            hover_color=Colors.Sepia,
            command=lambda: [self.select(self.patientsButton), patients.PatientsPage(master.window)],
            corner_radius=10,
            width=70,
            height=70,
            text="",
